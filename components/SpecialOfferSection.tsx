...
'use client'; // This component needs to be a client component for the countdown timer
...
export const SpecialOfferSection: React.FC = () => {
  ...
  const calculateTimeLeft = () => {
    // Current date in Mohanpur, Chittagong Division, Bangladesh (GMT+6)
    // To ensure consistency, it's best to calculate based on a UTC target and adjust display
    const now = new Date();
    // Assuming the offer ends at 10 PM on July 20, 2025 (GMT+6)
    // For a real application, fetch this from a server or define more robustly.
    const targetDate = new Date('2025-07-20T22:00:00+06:00'); // July 20, 2025, 10 PM GMT+6
